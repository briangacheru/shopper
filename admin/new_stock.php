...
<head>
    <head>
        ...
        <title>Shop Manager | New Stock</title>
								...
								?>
                                 <form class="form-horizontal row-fluid" action="action/new-stock.php" method="POST">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" placeholder="Product Name..." name="product" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Barcode…" name="barcode" required class="span8 tip">
											</div>
										</div>
