...
<head>
    <head>
        ...
        <title>Shop Manager | Product Categories</title>
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <div class="content">
								...
								<div class="controls">
												<input type="text" id="basicinput" placeholder="Category Name..." name="category" required class="span8"><button type="submit" class="btn">Add Category</button>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
								 ...
								 $sql = "SELECT * FROM product_categories WHERE shop = '$SEshopno' ORDER BY name";
						...
						$pname = $row['name'];
                               print '<tr class="odd gradeX">
                                                ...
                                                <td>
                                                <a ';?> onclick="return confirm('Are you sure you want to delete category <?php echo"$pname"; ?> ?');" <?php print 'href="action/delete_category.php?ref='.$pname.'" class="btn btn-small btn-danger">Delete category</a>
                                                </td>
                                 ...
                                 <div class="alert alert-success">
										...
										<h3 style="color:green">No Product Categories!</h3>
										All product category you register will be shown here.
									</div>
									</div>';
                                       }
