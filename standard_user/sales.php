...
<head>
    <head>
        ...
        <title>Shop Manager | Sales</title>
                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
								 ...
								 $sql = "SELECT * FROM sales WHERE signature = '$SEuserid'";
                               ...
                               print '<tr class="odd gradeX">
                                                ...
                                                <td>
                                                    '.number_format($row['price']).' '.$SEcur.'
                                                </td>
                                                <td class="center">
                                                   '.$row['amount'].' '.$row['unit'].'
                                                </td>
												<td>
                                                   '.number_format($row['total']).' '.$SEcur.'
                                                </td>
												<td>
                                                  '.$row['date'].'
                                                </td>
                                 ...
                                 <div class="alert alert-success">
										...
										All products you sold will be shown here.
									</div>
									</div>';
                                       }
