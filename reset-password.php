...
<head>
	...
	<title>Shop Manager | Reset Password</title>
...
<body>
	...
	<div class="wrapper" style="background-image: url(images/back4.jpg);">
		<div class="container" >
			<div class="row">
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-primary pull-right">Find my account</button>
